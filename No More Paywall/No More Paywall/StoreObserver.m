...
NSString *const IAPDownloadNotification = @"IAPDownloadNotification";
...
-(void)completeTransaction:(SKPaymentTransaction *)transaction forStatus:(NSInteger)status
{
    ...
    {
        // [[NSNotificationCenter defaultCenter] postNotificationName:IAPPurchaseFailedNotification object:self];
